    ...
    <div className="min-h-screen">
      ...
      <section className="py-24 px-6 bg-slate-50 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4">
          ...
          <Link href="/level-test" className="bg-white border-2 text-slate-900 border-slate-200 px-10 py-4 rounded-xl text-lg font-bold hover:scale-105 hover:bg-slate-50 transition">
            레벨 테스트 예약
          </Link>
        </div>
      </section>
